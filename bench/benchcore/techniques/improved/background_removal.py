...
class BackgroundRemover:
    ...
    def remove_background(self, image: np.ndarray, 
                         mask_threshold: int = 127) -> Tuple[np.ndarray, np.ndarray]:
        """
    ...
    def _static_background_removal(self, image: np.ndarray, 
                                 mask_threshold: int) -> Tuple[np.ndarray, np.ndarray]:
    ...
    def _adaptive_background_removal(self, image: np.ndarray,
                                   mask_threshold: int) -> Tuple[np.ndarray, np.ndarray]:
    ...
    def _simple_background_removal(self, image: np.ndarray,
                                 mask_threshold: int) -> Tuple[np.ndarray, np.ndarray]:
...
def apply_background_removal(image: np.ndarray, 
                           method: str = "simple",
                           background_image: Optional[np.ndarray] = None) -> Tuple[np.ndarray, np.ndarray]:
    """
