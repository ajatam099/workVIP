...
from bench.benchcore.eval.metrics import PerformanceMetrics
from bench.benchcore.utils.environment import capture_environment, generate_run_id, set_random_seeds
...
def main():
    ...
    parser.add_argument(
        "--config", "-c", required=True, help="Path to experiment configuration file"
    )
    parser.add_argument(
        "--run-id", default="auto", help='Run ID (use "auto" to generate automatically)'
    )
